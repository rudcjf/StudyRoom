...
import main.StudyroomPos;
import javax.swing.JToggleButton;

public class OrderView extends JFrame {

	JToggleButton adminToggleButton;
	OrderModel model;
	JTable tablePay;
	...
	class PayTableModel extends AbstractTableModel {
		...
		String[] columnNames = { "결제번호", "예약번호", "결제방법", "결제일", "가격" };
	...
	public void disableButton(int token) {
		if (token == 0) {
			adminToggleButton.setEnabled(false);
		}
	}
	...
	public void pay() {
		try {
			...
			p_way = (String) JOptionPane.showInputDialog(null, "결제 하시겠습니까?", "결제", JOptionPane.QUESTION_MESSAGE, null,
					selections, "카드");
	...
	public OrderView() {
		...
		tablePay.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		// 마우스 클릭시 액션
		...
		gbl_panel_Main1.columnWidths = new int[] { 0, 273, 0, 0, 0 };
		...
		adminToggleButton = new JToggleButton("결제내역포함보기");
		...
		adminToggleButton.setFont(new Font("맑은 고딕", Font.PLAIN, 15));
		...
		panel_Main1.add(adminToggleButton, gbc_tglbtnNewToggleButton);
